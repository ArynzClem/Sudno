...
async value(jid, buffer, head, body, footer, title, description, json, options) {
           ...
           if (Array.isArray(json[0])) {
               json.forEach(item => {
                ...
                const messageButtons = {"name": "single_select","buttonParamsJson": JSON.stringify({"title": title, "sections": [{ "title": description, "rows": buttons }] })}
                const urlButtons = {"name": "cta_url", "buttonParamsJson": JSON.stringify({"display_text": "канал судно", "url":"https://whatsapp.com/channel/0029VaUfG769sBI07M2YIY0B", "merchant_url": "https://whatsapp.com/channel/0029VaUfG769sBI07M2YIY0B"})}
